...
See [`docs/install.md`](../install.md) for the current recommended native path and [`docs/install-manual.md`](../install-manual.md#verify-installer-bytes-before-first-execution) for historical/manual verification, rollback, and container instructions.
