...
See [`docs/install.md`](../install.md) for the current recommended native path and [`docs/install-manual.md`](../install-manual.md) for portable extraction, historical/manual verification, rollback, and container usage.
