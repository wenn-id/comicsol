            ...
            [
                _panel(
                    ...
                    [
                        _dialogue(
                            "nadia",
                            "The dock story runs tonight or it never runs at all.",
                            "top-left",
                            1,
                            (0.28, 0.42),
                        ),
                        _dialogue(
                            "bram",
                            "Then give me a source I can actually print.",
                            "top-right",
                            2,
                            (0.71, 0.46),
                        ),
                ...
                _panel(
                    ...
                    [
                        _dialogue(
                            "nadia",
                            "I have the manifest. Two names, both signed.",
                            "top-left",
                            1,
                            (0.30, 0.40),
                        ),
                        _dialogue(
                            "bram",
                            "Names are not proof. Bring me the ledger.",
                            "top-right",
                            2,
                            (0.69, 0.44),
                        ),
                        _dialogue(
                            "nadia", "Then hold the front page.", "middle-left", 3, (0.32, 0.63)
                        ),
                    ],
                ),
            ],
...
ACTION_SEQUENCE = {
    ...
    "source": (
        "A rooftop courier is chased across a market district and has to drop a package mid-run.\n"
    ),
    "expected_pages": 1,
    "expected_panels": 3,
    "characters": _bible(
    ...
    "story": _story(
        ...
        [
            _scene(
                "river-bench",
                "raise the question",
                "concrete bench on the river wall",
                "late afternoon",
                ("mei", "ari"),
                RIVER_BENCH,
            ),
            ...
            [
                _panel(
                    ...
                    [
                        _dialogue(
                            "ari",
                            "Upriver there is work and dry ground.",
                            "top-left",
                            1,
                            (0.62, 0.45),
                        ),
                ...
                _panel(
                    ...
                    [
                        _dialogue(
                            "mei",
                            "We go, and we come back every flood.",
                            "top-left",
                            1,
                            (0.33, 0.44),
                        ),
                        _dialogue(
                            "ari", "Then I will buy two tickets.", "top-right", 2, (0.66, 0.46)
                        ),
                    ],
                ),
            ],
    ...
    "story": _story(
        ...
        [
            _scene(
                "union-hall",
                "divide the rations",
                "long union hall with folding chairs",
                "evening",
                ("dewi", "otto", "pia", "rex"),
                UNION_HALL,
            ),
            _scene(
                "back-alley",
                "settle the last claim",
                "alley behind the hall",
                "night",
                ("otto", "rex"),
                BACK_ALLEY,
            ),
            ...
            [
                _panel(
                    ...
                    [
                        _dialogue(
                            "dewi",
                            "One claim each, in order, and I write it down.",
                            "top-center",
                            1,
                            (0.48, 0.36),
                        ),
                        _dialogue(
                            "pia",
                            "The market taps feed everyone here.",
                            "middle-right",
                            2,
                            (0.72, 0.52),
                        ),
    ...
    "story": _story(
        ...
        [
            _scene(
                "empty-station",
                "hold the wait",
                "open platform of a rural station",
                "middle of the night",
                ("sora",),
                EMPTY_STATION,
            ),
    ...
    "story": _story(
        ...
        [
            _scene(
                "black-canal",
                "meet in the dark",
                "canal towpath during a blackout",
                "night",
                ("hana", "lamplighter"),
                BLACK_CANAL,
            ),
            ...
            [
                _panel(
                    ...
                    [
                        _dialogue(
                            "lamplighter",
                            "Stay inside the light and walk with me.",
                            "top-center",
                            1,
                            (0.55, 0.44),
                        ),
            ...
            [
                _panel(
                    ...
                    [
                        ...
                        _caption(
                            "Ilma had rehearsed the request for eleven years.", "bottom-left", 2
                        ),
                    ],
                ),
            ],
    ...
    "story": _story(
        ...
        [
            _scene(
                "night-market",
                "search the stalls",
                "covered night market with hanging signage",
                "evening",
                ("zaki", "oma-lin"),
                NIGHT_MARKET,
            ),
            _scene(
                "rail-yard",
                "find the crate",
                "loading rail yard behind the market",
                "night",
                ("zaki", "oma-lin"),
                RAIL_YARD,
            ),
        ...
        _page(
            ...
            [
                _panel(
                    ...
                    [
                        _dialogue(
                            "zaki", "Which aisle takes the crates?", "top-left", 1, (0.46, 0.56)
                        )
                    ],
                ),
                _panel(
                    ...
                    [
                        _dialogue(
                            "oma-lin", "Numbers lie after eight.", "top-right", 1, (0.60, 0.54)
                        )
                    ],
                ),
                _panel(
                    ...
                    [
                        _dialogue(
                            "oma-lin",
                            "Your uncle will hear about this.",
                            "top-center",
                            1,
                            (0.34, 0.62),
                        ),
...
FOUR_PAGE_STORY = {
    ...
    "story": _story(
        ...
        [
            _scene(
                "dry-well",
                "leave the dry village",
                "cracked village well",
                "morning",
                ("lira", "bakar"),
                DRY_WELL,
            ),
            _scene(
                "long-road",
                "carry the pump",
                "straight road across dry fields",
                "midday",
                ("lira", "bakar"),
                LONG_ROAD,
            ),
            _scene(
                "storm-ridge",
                "survive the dust storm",
                "exposed ridge above the road",
                "late afternoon",
                ("lira", "bakar"),
                STORM_RIDGE,
            ),
        ...
        _page(
            ...
            [
                _panel(
                    ...
                    [
                        _caption(
                            "The well had been dry since the second harvest.", "top-center", 1
                        ),
                        _dialogue(
                            "lira",
                            "We carry it to the valley today.",
                            "middle-left",
                            2,
                            (0.42, 0.66),
                        ),
        ...
        _page(
            ...
            [
                ...
                _panel(
                    ...
                    [
                        _dialogue(
                            "lira", "Half now, half at the ridge.", "top-center", 1, (0.38, 0.50)
                        )
                    ],
                ),
            ],
            ...
            [
                _panel(
                    ...
                    [
                        _dialogue(
                            "lira",
                            "There. The channel is still running.",
                            "top-left",
                            1,
                            (0.42, 0.52),
                        )
                ...
                _panel(
                    ...
                    [
                        _dialogue(
                            "lira",
                            "It still turns. We can start here.",
                            "top-center",
                            1,
                            (0.34, 0.70),
                        ),
...
def build_benchmark_project(root, scenario):
    ...
    root = Path(root)
    storyboard = build_storyboard(specification["pages"])
    panel_ids = [panel["id"] for page in storyboard["pages"] for panel in page["panels"]]
...
def build_benchmark_corpus(root):
    ...
    return {scenario: build_benchmark_project(root, scenario) for scenario in BENCHMARK_SCENARIOS}
